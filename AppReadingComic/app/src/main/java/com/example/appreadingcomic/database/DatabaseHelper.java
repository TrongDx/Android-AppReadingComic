...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String NAME_CHAP = "nameChap";
    ...
    private String SQLQuery4 = "INSERT INTO comic VALUES (null,'Rùa và Thỏ','Chap 12','Phần 1:\n" +
            "\n" +
    ...
    private String SQLQuery5 = "INSERT INTO comic VALUES (null,'Củ cải trắng','Chap 1','Mùa đông đã đến rồi trời lạnh buốt, Thỏ con không có gì để ăn cả. Thỏ con mặc áo vào rồi ra ngoài kiếm thức ăn. Nó đi mãi đi mãi cuối cùng cũng tìm được hai củ cải trắng. Thỏ con reo lên:\n" +
            "\n" +
    ...
    private String SQLQuery6 = "INSERT INTO comic VALUES (null,'Dê đen và dê trắng','chap 1','Dê đen và Dê trắng cùng sống trong một khu rừng. Hàng ngày, cả hai thường đến uống nước và tìm cái ăn ở trong khu rừng quen thuộc.\n" +
            "\n" +
    ...
    private String SQLQuery7 = "INSERT INTO comic VALUES (null,'Chú bé chăn cừu','chap 1','Một chú bé chăn cừu cho chủ thả cừu gần một khu rừng rậm cách làng không xa lắm. Chăn cừu được ít lâu, chú cảm thấy công việc chăn cừu thực là nhàm chán. Tất cả mọi việc chú có thể làm để giải khuây là nói chuyện với con chó hoặc thổi chiếc sáo chăn cừu của mình.\n" +
            "\n" +
    ...
    public int Delete(int i){
        ...
        int res = db.delete("truyen",ID_COMIC+" = "+i,null);
        return res;
