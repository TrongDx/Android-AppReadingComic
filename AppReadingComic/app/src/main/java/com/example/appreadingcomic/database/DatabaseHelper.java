package com.example.appreadingcomic.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME ="AppComic";
    ...
    private static String TABLE_COMIC = "comic";
    private static String ID_COMIC = "idComic";
    private static String NAME_COMIC = "nameComic";
    private static String CONTENT = "content";
    private static  String LINK_COMIC = "linkComic";
    ...
    private String SQLQuery1 = "CREATE TABLE "+ TABLE_COMIC +" ( "+ID_COMIC+" integer primary key AUTOINCREMENT, "
            +NAME_COMIC+" TEXT UNIQUE, "
            +CONTENT+" TEXT, "
    ...
    private String SQLQuery11 = "INSERT INTO TaiKhoan VAlUES (null,'user','user','user@gmail.com',1)";

    private String SQLQuery4 = "INSERT INTO comic VALUES (null,'Rùa và Thỏ','Phần 1:\n" +
            "\n" +
    ...
    private String SQLQuery5 = "INSERT INTO comic VALUES (null,'Củ cải trắng','Mùa đông đã đến rồi trời lạnh buốt, Thỏ con không có gì để ăn cả. Thỏ con mặc áo vào rồi ra ngoài kiếm thức ăn. Nó đi mãi đi mãi cuối cùng cũng tìm được hai củ cải trắng. Thỏ con reo lên:\n" +
            "\n" +
    ...
    private String SQLQuery6 = "INSERT INTO comic VALUES (null,'Dê đen và dê trắng','Dê đen và Dê trắng cùng sống trong một khu rừng. Hàng ngày, cả hai thường đến uống nước và tìm cái ăn ở trong khu rừng quen thuộc.\n" +
            "\n" +
    ...
    private String SQLQuery7 = "INSERT INTO comic VALUES (null,'Chú bé chăn cừu','Một chú bé chăn cừu cho chủ thả cừu gần một khu rừng rậm cách làng không xa lắm. Chăn cừu được ít lâu, chú cảm thấy công việc chăn cừu thực là nhàm chán. Tất cả mọi việc chú có thể làm để giải khuây là nói chuyện với con chó hoặc thổi chiếc sáo chăn cừu của mình.\n" +
            "\n" +
    ...
    private String SQLQuery9 = "INSERT INTO comic VALUES (null,'Cậu bé chăn cừu và cây đa cổ thụ','Ngày xửa ngày xưa, xưa lắm rồi khi mà muôn thú, cây cỏ, con người còn trò chuyện được với nhau. Trên đồng cỏ rậm ven khu làng có một loài cây gọi là cây đa. Đó là một thứ cây to, khỏe, lá của nó rậm rạp đến nỗi không một tia nắng nào có thể lọt qua được. Vào những ngày trời nắng nóng người ta thường nghỉ chân một lát và trò chuyện hàn huyên cùng cây dưới bóng cây mát rượi. Mọi người ai cũng biết rằng cây đa rất thông thái vì cây đã có tuổi, đã từng trải.\n" +
            "\n" +
            "\n" +
            "Một hôm, có một cậu bé chăn cừu ngồi nghỉ mát dưới gốc cây sau một ngày dài phơi mình dưới nắng cậu bé thấy người mệt mỏi và nóng bức. Một làn gió mơn man thổi thoa nhẹ lên tấm thân mỏi mệt của chú bé. Cậu bé bắt đầu thấy buồn ngủ. Vừa đặt mình xuống cậu bé bỗng ngước mắt nhìn lên những cành cây. Bấy giờ cậu bé bỗng thấy mình thật kiêu hãnh, cậu vẫn thường hay khoe với mọi người rằng cậu có tài chăn cừu và đàn cừu của cậu nhờ vậy mà lớn rất nhanh. Khi cậu bé phát hiện ra cây đa chỉ có những chùm quả rất nhỏ, nó bắt đầu thấy ngạc nhiên. Cậu bắt đầu chế giễu: hư, một cái cây to khỏe thế này mà làm sao chỉ có những bông hoa những chùm quả bé tí tẹo thế kia, mọi người vẫn bảo là cái cây này thông thái lắm kia mà nhưng làm sao nó có thể thông thái khi mà quả của nó chỉ toàn bé xíu như vậy. Dĩ nhiên là cây đa nghe hết những lời của cậu bé nhưng cây vẫn im lặng và cành lá chỉ khẽ rung rinh đủ để cho gió cất lên khúc hát ru êm dịu. Cậu bé bắt đầu ngủ, cậu ngáy o o…. Cốc.\n" +
            "Quả đa nhỏ rụng chính giữa trán của cậu bé, nó bừng tỉnh nhưng càu nhàu: “Gừm… người ta vừa mới chợp mắt được có một tí”, rồi nó nhặt quả đa lên chưa hết chưa biết định làm gì với quả đa này bỗng nhiên cậu bé nghe thấy có tiếng cười khúc khích, cậu nghe thấy cây hỏi:\n" +
...
//    }
    ...
    public void AddTaiKhoan(Account account){
        ...
        values.put(PHAN_QUYEN,account.getDecentralization());
    ...
    //Thêm truyện
    public void AddTruyen(Comic comic){
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(NAME_COMIC,comic.getNameComic());
        values.put(CONTENT,comic.getContent());
        values.put(LINK_COMIC,comic.getLinkComic());
        values.put(ID_TAI_KHOAN,comic.getID());
    ...
    public Cursor getData1(){
        ...
        Cursor res =  db.rawQuery( "select * from "+TABLE_COMIC+" ORDER BY "+ID_COMIC+" DESC" , null );
        return res;
    }
    ...
    public Cursor getData2(){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM "+TABLE_COMIC,null);
        return res;
    }
    ...
    public int Delete(int i){
        ...
        int res = db.delete("comic",ID_COMIC+" = "+i,null);
        return res;
